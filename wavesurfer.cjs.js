...
WaveSurfer.WebAudio = {
    ...
    createScriptNode: function () {
        ...
        this.scriptNode.connect(this.params.destination ? this.params.destination: this.ac.destination);
    },
    ...
    createVolumeNode: function () {
        ...
        this.gainNode.connect(this.params.destination ? this.params.destination: this.ac.destination);
    },
